                    ...
                    <div class="col-md-6 col-12 mx-auto">
                      ...
                      <form:form class="row g-3" method="post" action="/admin/product/create"
                        ...
                        <div class="mb-3 col-12 col-md-6">
                          ...
                          <form:input type="text" class="form-control" id="price" placeholder="Price Product"
                            path="price" />
                        </div>
                        <div class="mb-3 col-12 col-md-6">
                          <label for="factory" class="form-label">Factory</label>
                          <form:input type="text" class="form-control" id="factory" placeholder="Factory"
                            path="factory" />
                        </div>
                        <div class="mb-3 col-12 col-md-6">
                          <label for="quantity" class="form-label">Quantity</label>
                          <form:input type="text" class="form-control" id="quantity" placeholder="Quantity"
                            path="quantity" />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 col-12 col-md-6">
                          ...
                          <form:input type="text" class="form-control" id="sold" placeholder="Sold" path="sold" />
                        </div>
                        <div class="mb-3 col-12 col-md-6">
                          <label for="formFileMultiple" class="form-label">Images Product</label>
                          <input class="form-control" type="file" id="avatarFile" name="fileName" multiple
                            accept=".png, .jpg, .jpeg" />
                        </div>
                        <div class="col-12 col-md-6">
                          <img style="max-width: 250px; display: none" alt="images" id="avatarPreview" />
                        </div>
                        <div class="mb-3">
                          <label for="target" class="form-label">Target Products</label>
                          <form:textarea class="form-control" id="target" rows="3" path="target"></form:textarea>
                        </div>
                        <div class="col-12">
